...
/**
 * La classe Traitement ne peut etre instanciee, elle contient simplement quelques
 * fonctions de traitement des graphes de l'editeur Editeur.
 * C'est une "boite a outils".
 **/
public class Traitements {
  ...
  /**
   * On passe a cette methode une enumeration de sommets et d'aretes.
   *
   * @return un ensemble contenant tous les sommets de l'enumeration
   * enumeration et les sommets incidents des aretes de cette meme enumeration.
   **/
     ...
     * enumeration et les aretes incidentes aux sommets de cette meme enumeration.
     */
  ...
  /**
   * Cette methode complete le sous-graphe forme par ces sommets.
   *
  ...
  /**
   * Duplique tous les elements contenus dans une selection.
   *
   * @return une selection contenant tous les clones.
   **/
  ...
  /**
   * Cette methode selectionne le sous_graphe connexe auquel appartient le sommet passe en argument.
   * Le calcul tient compte de l'orientation des aretes.
   *
   * @return une selection contenant les sommets et les aretes du sous-graphe connexe contenant le sommet.
   **/
  public static SelectionDessin sousGrapheConnexeOriente(
    ...
    */
    ...
    /**
   * Cette methode selectionne le sous_graphe connexe auquel appartient le sommet passe en argument.
   * Le calcul ne tient pas compte de l'orientation des aretes.
   *
   * @return une selection contenant les sommets et les aretes du sous-graphe connexe contenant le sommet.
   **/
