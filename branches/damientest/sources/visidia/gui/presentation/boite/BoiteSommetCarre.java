...
/** Cette classe "raffine" sa super classe en lui ajoutant les champs permettant *  d'afficher et de modifier les caracteristiques specifiques d'un sommet carre*/

public class BoiteSommetCarre extends BoiteSommetDessin implements ActionListener {
    
    /** Le panel dans lequel on affiche les proprietes (caracteristiques non graphiques) du sommet.*/
    ...
    /** Cree une nouvelle boite, centree sur "parent" pour afficher les caracteristiques de "un_sommet".
     * La boite sera appelee "titre"
     * Suivant la valeur de "est_editable", les caracteristiques du sommet sont modifiables.*/
