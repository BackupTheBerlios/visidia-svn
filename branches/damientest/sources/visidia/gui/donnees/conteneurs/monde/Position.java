...
import java.io.*;
/**
 * Un objet de classe Position est en quelque sorte une reference
 * pointant sur un element d'un monde. C'est cette classe qui 
 * encapsule l'objet situe a la "position" courante dans le monde.
 **/
public class Position implements Serializable {
  ...
  /**
   * Retourne l'element du monde correspondant a cette position.
   **/
  ...
  /**
   * Supprime du monde l'element corespondant a cette position
   **/
