/**
 *Algorithme distribue d'election dans un graphe anonyme.
 *Marche bien pour les arbres,et les anneaux, et en general pour
 *les reseaux dont le diametre (plus grand chemin) est inferieur au plus
 *petit cycle.Pour avoir un algorithme qui marche pour tout type de 
 *reseau,on doit pouvoir connaitre le degre du reseau.
 **/
...
public class ElectionRmi extends AlgorithmDist {
    ...
    /**
     *Algorithme d'election.L'algorithme implemente est celui de Lelanns,
