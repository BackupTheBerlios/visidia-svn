...
public interface Vertex {
     ...
     * Les voisins sont a partir de 0 dans leur ordre d'arrivée.
     * Ne pas confondre les numeros et les identités.
     ...
     * @exception NoSuchLinkException levée si le sommet identifie par <i>id</i>
