...
public class SimpleGraph implements Cloneable, Serializable{
    ...
    /* nouvelle methode pour positionner le suivant si l'arete est orienté*/
    ...
    /**
     *retourne l'arete liant les deux sommets identifiés respectivements par
     * <i>id1</i> et <i>id2</i>.
     * @exception NoSuchIdException levée si le graphe ne 
     * contient pas l'une des identitées <i>id1</i> et <i>id2</i>.
     * @exception NoSuchLinkException levée s'il n'y a pas d'arete entre 
	...
	/* empile les elements à supprimer.
