package sources.fr.enserb.das.algo;
...
/**
 * Exemple d'implémentation des règles de réécriture,à l'aide de vecteurs.
 */

import java.util.Vector;

public class SimpleRule_1 implements Serializable {
    private Arrow leftMember;
    private Arrow rightMember;
   


    public SimpleRule_1(Arrow gauche, Arrow droite){
	leftMember = gauche;
	rightMember = droite;
    }
