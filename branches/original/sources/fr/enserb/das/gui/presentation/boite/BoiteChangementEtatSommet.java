...
/**
 * Cette classe crée une boite utilisée pour modifier l'etat d'un    
 * ou de plusieurs sommets selectionne elle est applee quand on ne    
 * selectionne que des sommets et qu'on appui sur le bouton info     
*/
public class BoiteChangementEtatSommet implements ActionListener, ItemListener  {
