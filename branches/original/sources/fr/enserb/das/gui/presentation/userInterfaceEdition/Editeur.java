 ...
 * de classe Graphe). C'est dans cette classe que sont implémentés les menus
 * et les méthodes de "haut niveau" appelées lors de l'exécution d'une commande par
 * l'utilisateur. Par contre l'affichage "intéractif" du graphe est assuré par la
 * classe GrapheVisuPanel.<BR>
 * Parmi les variables d'instance de cette classe, il faut bien distinguer 2 catégories
 * distinctes: les variables qui décrivent l'état courant de l'éditeur (comme par
 * exemple les objets sélectionnés, les objets visuablisables servant de modèle à
 * la création de nouveaux sommets et de nouvelle arêtes, ...) et les variables
 * décrivant l'état du document édité (parmi lesquelles on trouve biensûr le
 * VueGraphe, mais aussi la taille de la zone de travail, la couleur de fond, ...). Seules
 * les variables de la seconde catégorie sont sauvegardées sur disque, les autres sont
 * toujours initialisées à des valeurs par défaut lors de l'ouverture d'un document.
 **/

public class Editeur extends Fenetre implements ActionListener, WindowListener ,ItemListener{
    
    
    /** Objet <b>UndoInfo</b> qui permet de réaliser les opérations de "undo" et "redo". **/
    ...
    /** Number of operations for annulation or restauration annulées with undo/redo by group.*/
    protected int nb_op = 5;
    
    /** La description de l'annulation d'une opération effectuée.*/
    protected String undoDescription = "";
    /** La description de la restauration d'une opération effectuée.*/
    ...
    /**
     * Crée une nouvelle fenêtre d'édition contenant un document vierge:
     * un Graphe vide et des caractéristiques (taille de la zone de
     * travail, couleur de fond, ...) ayant des valeurs par défaut.
     **/
    public Editeur() {
     ...
     * complètement le document édité. Des données telles que le
     * modèle de sommet (ou d'arête), le fichier édité, les objets
     * sélectionnés,... ne font pas partie des arguments car il ne s'agit
    ...
    /**
     * Cette méthode ajoute la barre de menu, ses menus et sous_menus à l'éditeur.
     **/
    ...
    /**
     * Cette méthode ajoute la barre d'outils et ses boutons à l'éditeur.
     **/
    ...
    /** Crée un GrapheVisuPanel rattaché à l'éditeur courant. **/
    public GrapheVisuPanel creerGrapheVisuPanel() {
	return new GrapheVisuPanel(this);
    }
    
    /** Retourne le GrapheVisuPanel servant à l'édition.**/
    ...
    /**
     * Cette méthode retourne une chaîne qui est utilisée pour construire
     * le titre de la fenêtre et pour savoir dans quel type d'éditeur le
     * graphe est édité.
     **/
     ...
     * trouve la fonctionnalité sélectionnée.
     **/
    ...
    /**
     * Méthode de redirection du traitement suivant le bouton sélectionné
    ...
    /** Méthode de traitement des fonctionnalités du menu Edition. **/
    ...
    /** Méthode de traitement des fonctionnalités du menu Transformation. **/
    ...
    /** Méthode de traitement des fonctionnalités du menu Options. **/
    ...
    /**
     * Commande de renumérotation des sommets du graphe.
     **/
     ...
     *
     * le graphe tout entier si la sélection est vide; 
     * la partie du graphe sélectionnée sinon.
     * 
     */
     ...
     *
     * <ul>
     * <li>des arêtes contenues dans la sélection; </li>
     * <li>de toutes les arêtes du graphe si la sélection est vide.</li>
     * </ul>
     **/
     ...
     * <li>du graphe tout entier si la sélection est vide. </li>
     * </ul>
     * Les duplicata deviennent les nouveaux objets sélectionnés.
     **/
    ...
    /**
     * Commande d'ouverture d'une boîte de dialogue permettant d'ouvrir un nouvel
     * éditeur du type désiré.
     **/
 
    /**
     * Commande de changement du nombre d'opérations à annuler ou à 
     * restaurer grâce aux commandes de undo/redo par groupes.
     **/
    ...
    /**
     * Cette méthode met <b>nb_op</b> à la valeur "i" et réactualise le 
     * texte des éléments de menus <b>edition_undoBySet</b> et  b>edition_redoBySet</b>
     **/
    ...
    /**
     * Commande de réinitialisation de l'éditeur.
     * <BR> Appelée avant l'ouverture d'un fichier si celui-ci contient
     * un graphe du même type que l'éditeur courant.
     **/
    ...
    /**
     * Permet de donner à <b>description</b> la valeur passée en argument.
     **/
