...
public class Boite extends JOptionPane {
  ...
  /** La fenêtre parente : la boite sera centrée par rapport à cette fenêtre.*/
  ...
  /** Construit une boite de type <b>type</b>, centrée sur <b>parent</b>, et dont le titre sera <b>titre</b>
    * <br>Le constructeur n'affiche pas la boite.
    * @param type Un entier qui représente le type de la boite.
  ...
  /** Construit une boite de type OK_CANCEL (deux boutons), centrée sur <b>parent</b>, et dont le titre sera <b>titre.</b>
    * <br>Les labels par défaut des boutons sont remplacés par ceux passés en arguments.
    * <br>Le constructeur n'affiche pas la boite.*/
  public Boite(JFrame parent,
	       String title,
	       String labelGauche,
    ...
    /*
     * Cette méthode permet de créer l'intérieur de la boite.        
     * Elle est redéfinie dans toutes les sous_classes de Boite.<br>  
     * Le JComponent retourné, qui peut contenir n'importe quel      
     * composant Swing ou AWT, sera ajouté dans la boite, au dessus  
     * des boutons correspondant au type de boite choisi.            
     * Si des boutons sont ajoutés à ce composant,                   
     * les appels de méthodes associés à l'action sur ces boutons    
     * peuvent être faits grâce aux méthodes de l'interface          
     * ActionListener.                                               
     */
  public JComponent createContent() {
    ...
    /**
     * Cette méthode fait appel à <b>createContent</b> pour créer le 
     * contenu de la boite, et affiche ensuite la boite.             
     * Quand l'utilisateur  appuie sur un bouton de la boite,        
     * celle-ci disparaît. Si le bouton utilisé est le bouton "ok",  
     * la méthode <b>boutonOkAppuye</b> est appelée.                 
     * Sinon, la méthode <b>boutonCancelAppuye</b> est appelée.      
     */
     ...
     * @param closeable Si ce booléen vaut VRAI, la fermeture de la boite 
     */
