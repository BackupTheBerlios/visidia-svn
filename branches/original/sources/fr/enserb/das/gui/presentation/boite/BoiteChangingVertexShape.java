...
public class BoiteChangingVertexShape extends BoiteChangingShape implements ActionListener, ItemListener {
    ...
    //Construsteurs
    /** Crée une nouvelle boite pour afficher les caractéristiques */
    public BoiteChangingVertexShape(JFrame parent, VueGraphe gr) {
	this(parent,gr, "Vertices shape");
    }
    
    
    /** Crée une nouvelle boite, centrée sur "parent" 
     * La boite sera appelée "titre"
     * Suivant la valeur de "est_editable", les caractéristiques des sommets sont modifiables.
     **/
