...
/**
 * La classe Traitement ne peut être instanciée, elle contient simplement quelques
 * fonctions de traitement des graphes de l'éditeur Editeur.
...
public class Traitements {
  ...
  /**
   * On passe à cette méthode une énumeration de sommets et d'arêtes.
   *
   * @return un ensemble contenant tous les sommets de l'enumeration
   * énumération et les sommets incidents des arêtes de cette meme énumération.
   **/
    public static Ensemble sommetsTotaux(Enumeration enum){
	Ensemble ensemble = new Ensemble();
	while(enum.hasMoreElements()) {
	    FormeDessin f = (FormeDessin)enum.nextElement();
    ...
    /* On passe à cette méthode une énumeration de sommets et d'arêtes. 
     * 
     * @return un ensemble contenant tous les sommets et aretes de l'
     * énumération et les aretes incidentes aux sommets de cette meme énumération.
     */
    public static Ensemble elementsTotaux(Enumeration enum){
	Ensemble ensemble = new Ensemble();
	while(enum.hasMoreElements()) {
	    FormeDessin f = (FormeDessin)enum.nextElement();
  ...
  /**
   * Cette méthode complète le sous-graphe formé par ces sommets.
   *
   * @param e énumération de SommetDessin
   *
   * @return an enumeration of created edges
   **/
  public static Enumeration completersousGraphe(Enumeration enum) {
      Ensemble ensembleArete = new Ensemble();
      Enumeration e = sommetDessin(enum);
  ...
  /**
   * Cette méthode sélectionne le sous_graphe connexe auquel appartient le sommet passé en argument.
   * Le calcul tient compte de l'orientation des arêtes.
   *
   * @return une selection contenant les sommets et les arêtes du sous-graphe connexe contenant le sommet.
   **/
  public static SelectionDessin sousGrapheConnexeOriente(
    ...
    */
    ...
    /**
   * Cette méthode sélectionne le sous_graphe connexe auquel appartient le sommet passé en argument.
   * Le calcul ne tient pas compte de l'orientation des arêtes.
   *
   * @return une selection contenant les sommets et les arêtes du sous-graphe connexe contenant le sommet.
   **/
    public static SelectionDessin sousGrapheConnexe(Enumeration enum) {
	Enumeration sommets_initiaux = sommetDessin(enum);
	if(!sommets_initiaux.hasMoreElements())
	    return null;
