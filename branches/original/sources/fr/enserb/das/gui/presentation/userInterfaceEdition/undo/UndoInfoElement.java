...
/** Cette classe contient les informations permettant d'annuler ou de restaurer une opération. C'est une sous-classe de Vector, car une opération de l'utilisateur peut être composée de plusieurs opérations simples. */
...
public class UndoInfoElement extends Vector{
  ...
  /** Appelle "undo" pour chacun des éléments, dans l'ordre inverse de leur introduction dans le vecteur. */
  public void undo() {
  ...
  /** Appelle "redo" pour chacun des éléments, dans l'ordre de leur introduction dans le vecteur. */
  public void redo() {
