...
/** Cette classe implémente la partie graphique d'un graphe. **/
public class VueGraphe implements Serializable{
 ...
 /**
  ...
  public void couleursStandards() {
    ...
    /**
   * Retourne une énumeration qui contient les sommets dessines du graphe.
   **/
 ...
 /**
   * Accesseur à afficherEtiquettes.
   **/
  ...
  /**
   * Positionne si oui ou non on affiche les étiquettes.
   **/
  ...
  /**
   * Créer un nouveau sommet dans le graphe avec une position donnée.
   **/
   ...
   /**
    * Créer une nouvelle arête dans le graphe en précisant ses sommets d'origine
    * et de destination
    **/
...
// pour les sommets : pour les differents types d'affichage
  ...
  /**
   * Renumérote tous les sommets en partant de 0 et positionne la variable
  ...
  /**
   * Retourne une chaîne de caractères identifiant le type du graphe courant.
   * Classiquement, chaque classe retourne un type différent.
   **/
  public String type() {
  ...
  /**
   * Retourne un objet du graphe se trouvant à la position donnée.
   **/
  ...
  /**
   * Renvoie l'ensemble des objets contenus dans le graphe sous la forme d'une énumération.
   **
  ...
  */
  ...
  /**
   * Renvoie l'ensemble des objets contenus dans le graphe dans la zone déterminée par les
   * coordonnées données en paramètre.
   **/
  ...
  /**
   * Renvoie sous la forme d'une string une description des caractéristiques graphiques
   * des sommets stockées lors d'une sauvegarde texte .
   **/
  ...
  /**
   * Renvoie sous la forme d'une string une description des caractéristiques abstraites
   * des sommets stockées lors d'une sauvegarde texte .
   **/
  ...
  /**
   * Retourne un sommet du graphe se trouvant à la position donnée.<BR>
   * Une exception NoSuchElementException est levée si aucun sommet n'est trouvé.
   **/
  ...
  /**
   * Retourne un sommet du graphe se trouvant à la position donnée, mais pas
   * celui passé en argument.<BR>
   * Une exception NoSuchElementException est levée si aucun sommet n'est trouvé.
   **/
  public SommetDessin sommet_en_dessous(int x, int y,
  ...
  /**
   * Retourne une arête du graphe se trouvant à la position donnée.<BR>
   * Une exception NoSuchElementException est levée si aucune arête n'est trouvée.
   **/
  ...
  /**
   * Retourne une arête du graphe se trouvant à la position donnée, mais pas
   * celle passée en argument.<BR>
   * Une exception NoSuchElementException est levée si aucune arête n'est trouvée.
   **/
  ...
  /**
   * Retourne un FormeDessin du graphe se trouvant à la position donnée, mais pas
   * celui passé en argument.<BR>
   * Une exception NoSuchElementException est levée si aucune forme n'est trouvée.
   **/
  ...
  public SommetDessin  rechercherSommet(String id){
    ...
    /**
     * Permet de déplacer l'ensemble des éléments contenus dans la sélection.
     **/
