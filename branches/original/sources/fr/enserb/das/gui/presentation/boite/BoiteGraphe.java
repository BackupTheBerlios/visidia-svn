...
/** Cette boite affiche les propriétés d'un graphe et de son éditeur (couleur de fond, taille...)
...
public class BoiteGraphe extends Boite implements ActionListener, ChangeListener {
  ...
  /** Le curseur permettant de régler la largeur du plan de travail.*/
  protected JSlider x_slider;
  /** Le curseur permettant de régler la hauteur du plan de travail.*/
  protected JSlider y_slider;
  protected JLabel colorLabel, heightLabel, widthLabel;
  
  /** L'éditeur dont on affiche les propriétés.*/
  protected Editeur editeur;
  /** Un booléen qui vaut VRAI si une des valeurs affichées dans la boite est différente de la valeur effective.*/
  protected boolean modif = false;
  /** La valeur de la largeur du plan de travail affichée dans la boite.*/
  protected int new_width;
  /** La valeur de la hauteur du plan de travail affichée dans la boite.*/
  protected int new_height;
  /** La couleur du plan de travail affichée dans la boite.*/
  ...
  /** Cette méthode est appelée quand l'utilisateur clique sur le bouton <b>Choose color</b> ou sur le bouton <b>Apply</b> */
  ...
  /** Cette méthode est appelée quand l'utilisateur actionne l'une des deux jauges permettant de régler la taille du plan de travail.*/
