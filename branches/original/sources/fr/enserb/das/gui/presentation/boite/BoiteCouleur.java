...
/** Cette classe crée une boite de type JColorChooser **/
public class BoiteCouleur implements ActionListener {
    
    // le panel dans lequel on va créer la boite
     ...
     * @param label le titre affiché dans le label.
     ...
     * @param est_editable si ce booléen est vrai, le bouton sera actif
     **/
    ...
    // Methode appelée quand l'utilisateur appuie sur le bouton
