...
import fr.enserb.das.tools.ArrowHeadFactory;
...
public abstract class AreteDessin extends FormeDessin{
	...
	if(etatArete){
	    ...
	    g.drawLine(origx, origy, destx, desty);
	    ...
	    //	    if(isOriented){
	    if(false){
		Shape arrowHead = ArrowHeadFactory.createSegmentArrowHead(new Point(origx, origy), 
