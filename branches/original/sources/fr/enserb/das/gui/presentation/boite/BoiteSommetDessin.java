 ...
 *  d'afficher et de modifier les caractéristiques spécifiques au sommets
 **/ 
...
public class BoiteSommetDessin extends BoiteFormeDessin{
  ...
  protected JTextField centreX;
    // Le champ de saisie de l'ordonnée du sommet.
  ...
  /** Crée une nouvelle boite pour afficher les caractéristiques de "sommet". Ces caractéristiques seront modifiables.*/
  ...
  /** Crée une nouvelle boite appelée "titre" pour afficher les 
    caractéristiques de "sommet". Suivant la valeur de "est_editable", 
  les caractéristiques de l'ObjetVisu seront modifiables.*/
  public BoiteSommetDessin(JFrame parent, SommetDessin sommet,
  ...
  public void buttonOk() {
    ...
    /** Cette méthode permet d'activer ou de désactiver le bouton de sélection 
    de la couleur de fond du SommetDessin, en fonction de la valeur du booléen 
    passé en argument..*/
