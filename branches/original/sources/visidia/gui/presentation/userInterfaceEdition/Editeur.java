...
/**
 * La classe Editeur est particulierement importante, elle implemente la fenetre
 * (une "JFrame") dans laquelle les graphes sont edites (un graphe est un objet
 * de classe Graphe). C'est dans cette classe que sont implementes les menus
 * et les methodes de "haut niveau" appelees lors de l'execution d'une commande par
 * l'utilisateur. Par contre l'affichage "interactif" du graphe est assure par la
 * classe GrapheVisuPanel.<BR>
 * Parmi les variables d'instance de cette classe, il faut bien distinguer 2 categories
 * distinctes: les variables qui decrivent l'etat courant de l'editeur (comme par
 * exemple les objets selectionnes, les objets visuablisables servant de modele a
 * la creation de nouveaux sommets et de nouvelle aretes, ...) et les variables
 * decrivant l'etat du document edite (parmi lesquelles on trouve biensur le
 * VueGraphe, mais aussi la taille de la zone de travail, la couleur de fond, ...). Seules
 * les variables de la seconde categorie sont sauvegardees sur disque, les autres sont
 * toujours initialisaes a des valeurs par defaut lors de l'ouverture d'un document.
 **/

public class Editeur extends Fenetre implements ActionListener, WindowListener ,ItemListener{
    
    
    /** Objet <b>UndoInfo</b> qui permet de realiser les operations de "undo" et "redo". **/
    ...
    /** Number of operations for annulation or restauration annulees with undo/redo by group.*/
    protected int nb_op = 5;
    
    /** La description de l'annulation d'une operation effectuee.*/
    protected String undoDescription = "";
    /** La description de la restauration d'une operation effectuee.*/
    ...
    /**
     * Un constructeur dont les arguments permettent de specifier
     * completement le document edite. Des donnees telles que le
     * modele de sommet (ou d'arete), le fichier edite, les objets
     * selectionnes,... ne font pas partie des arguments car il ne s'agit
     * pas de donnees propres au document mais des donnees definissant
     * l'etat courant de l'editeur.
     **/
    ...
    /**
     * Cette methode ajoute la barre de menu, ses menus et sous_menus a l'editeur.
     **/
    ...
    /**
     * Cette methode retourne une chaine qui est utilisee pour construire
     * le titre de la fenetre et pour savoir dans quel type d'editeur le
     * graphe est edite.
     **/
     ...
     * traitement de l'appui sur les menus deroulants et
    ...
    /**
     * Methode de redirection du traitement suivant le menu dans lequel se
     * trouve la fonctionnalite selectionnee.
     **/
    ...
    /**
     * Methode de redirection du traitement suivant le bouton selectionne
    ...
    /** Methode de traitement des fonctionnalites du menu File. **/
    ...
    /** Commande de suppression des elements de la selection courante. **/
    ...
    /** Commande de fermeture de l'editeur courant. **/
    ...
    /**
     * Commande d'affichage des proprietes : 
     *
     *  du ou des elements de la selection
     *  du graphe tout entier, si la selection est vide.
     * 
     */
     ...
     * la partie du graphe selectionnee sinon.
     * 
     */
     ...
     *
     * <ul>
     * <li>des aretes contenues dans la selection; </li>
     * <li>de toutes les aretes du graphe si la selection est vide.</li>
     * </ul>
     **/
    public void commandeSupprimerAretes() { // Penser au repaint()
	if(selection.estVide()) {
	    /* On va utiliser une pile intermediaire pour pouvoir supprimer */
	    /* les elements dans l'ordre (sinon, on ne peut pas : la methode */
	    /* nextElement plante!! */
    ...
    /**
     * Commande qui permet de vider la selection courante.
     */
    ...
    /**
     * Commande de selection de la totalite du graphe edite.
     */
     ...
     *
     * <ul>
     * <li>des elemants contenus dans la selection; </li>
    ...
    /**
     * Commande de selection du sous-graphe connexe contenant les elements
    ...
    /**
     * Commande de selection du sous-graphe connexe oriente contenant les
     * elements de la selection courante.
     **/
    ...
    /**
     * Commande d'ouverture d'une boite de dialogue permettant d'ouvrir un nouvel
     * editeur du type desire.
     **/
 
    /**
     * Commande de changement du nombre d'operations a annuler ou a 
    ...
    /**
     * Cette methode met <b>nb_op</b> a la valeur "i" et reactualise le 
     * texte des elements de menus <b>edition_undoBySet</b> et  d'edition_redoBySet</b>
     **/
    ...
    /**
     * Commande de remise a jour du dessin du graphe.
     **/
    ...
    /**
     * Commande de modification de la couleur de fond de l'editeur.
     **/
    ...
    /**
     * Renvoie le nom de la classe de l'editeur.
     **/
    ...
    /**
     * Commande de reinitialisation de l'editeur.
     * <BR> Appelee avant l'ouverture d'un fichier si celui-ci contient
     * un graphe du meme type que l'editeur courant.
     **/
    ...
    /**
     * Permet de donner a <b>description</b> la valeur passee en argument.
     **/
     ...
     * l'etat des "piles" d'actions undo et redo.
     **/
    public void setUndo() {
