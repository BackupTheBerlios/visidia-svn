...
public abstract class Fenetre extends JFrame {
 // Quelques constantes
  ...
  /** Le graphe-visualisable manipule */
  protected VueGraphe vueGraphe;
 /** La selection est consideree comme une donnee courante */
 ...
 /** Le fichier edite */
  ...
  /** ContentPane de la JFrame : le panel dans lequel on va ajouter des elements d'interface*/
  protected JPanel content;

  /** Pane qui supporte le grapheVisu*/
  protected JScrollPane scroller;

    /** Retourne le VueGraphe edite. **/
 ...
 /**
   * Cette methode met a jour le titre de la fenetre : elle est appelee
  ...
  /**
   *  Met a jour le titre de la fenetre a partir d'un fichier:
   * on appelle cette methode a l'ouverture d'un fichier.
   **/
