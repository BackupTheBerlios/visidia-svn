...
/** Cette classe cree un panel qui contient un bouton et un label. Le label affiche 
la valeur d'une couleur (format R,G,B), et le bouton permet d'ouvrir une boite de choix 
de couleur. Ce panel sera affiche a l'interieur d'une fenetre, sous la forme d'une ligne.
...
public class LigneChoixCouleur implements ActionListener {
  ...
  /** Le panel dans lequel on affichera les elements.*/
  ...
  /** Active ou desactive le bouton suivant la valeur du booleen "editable" passe en argument.*/
