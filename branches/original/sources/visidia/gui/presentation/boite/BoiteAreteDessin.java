...
public class BoiteAreteDessin extends BoiteFormeDessin implements ActionListener {
    ...
    // Variable d'instance
    /** Le champ de saisie de l'abscisse de l'origine de la fleche.*/
    protected JTextField origineX;
    /** Le champ de saisie de l'ordonnee de l'origine de la fleche.*/
    protected JTextField destinationX;
    /** Le champ de saisie de l'abscisse de la destination de la fleche.*/
    protected JTextField origineY;
    /** Le champ de saisie de l'ordonnee de la destination de la fleche.*/
    protected JTextField destinationY;
    /** La valeur de l'abscisse de l'origine de la fleche.*/
    protected int initialStartX;
    /** La valeur de l'ordonnee de l'origine de la fleche.*/
    protected int initialStartY;  
    /** La valeur de l'abscisse de la destination de la fleche.*/
    protected int initialEndX;
    /** La valeur de l'ordonnee de la destination de la fleche.*/
    ...
    /** Cree une nouvelle boite, centree sur "parent" pour afficher les caracteristiques de "une_arete".
     * La boite sera appelee "titre"
     * Suivant la valeur de "est_editable", les caracteristiques de l'arete sont modifiables.
     **/
    ...
    /** Cette methode est appelee quand l'utilisateur actionne un des boutons de la boite.*/
   ...
   /** Cette methode est appelee quand l'utilisateur appuie sur le bouton Ok */ 
