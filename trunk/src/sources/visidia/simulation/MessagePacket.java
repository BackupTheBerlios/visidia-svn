...
/**
 * cette classe permet d'encapsuler un message qui est en transite sur le
 * réseaux.
 */
public class MessagePacket implements Serializable {
	...
	/**
	 * construit un paquet cotenant un message envoyé par le noeud identifié par
	 * <i>senderId</i> au noeud identifié par <i>receiverId</i>.
	 */
	public MessagePacket(Integer senderId, int srcDoor, Integer receiverId,
			int destDoor, Message msg) {
