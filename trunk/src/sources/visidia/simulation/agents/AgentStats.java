...
/**
 * Class used to compute some statistics on the progress of the simulation. Add
 * methods to this class to compute in an other way. The methods implemented
 * only increment the values computed.
 */
public class AgentStats {
	 ...
	 * 
	 * @param key
	 *            The key given to seek in the Hashtable.
	 */
	 ...
	 *            The key given to seek in the Hashtable.
	 * @param increment
	 *            Increment that will be added to the value.
	 */
