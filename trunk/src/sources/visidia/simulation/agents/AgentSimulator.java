...
public class AgentSimulator {
    ...
    /**
         * If an agent want to lock the WhiteBoard of a Vertex, all informations
         * are stored here.
         */
    ...
    /**
         * Adds a specified agent to a specified vertex. Returns the new number
    ...
    /**
         * Removes a specified agent from a specified vertex. Returns the new
    ...
    /**
         * Handles agents' death. It removes the agents from the Hashtable. When
         * the Hashtable is empty it is the end of the algorithm.
         */
    ...
    /**
         * Sends an event to tell graphical interface that a new pulse is
         * starting
         * 
         * @param pulse
         *                the current pulse
    ...
    /**
         ...
         * 
         * @param ag
         *                the Agent which wants to know who has locked the
         *                Vertex Properties
         * @see #lockVertexProperties(Agent)
         */
    ...
    /**
         ...
         * 
         * @param ag
         *                the Agent which wants to know if it Vertex properties
         *                are locked
         * @see #lockVertexProperties(Agent)
         */
    ...
    /**
         * Lock the Vertex WhiteBoard where the Agent is. If already locked,
         * wait until the owner unlocks it
         * 
         * @param ag
         *                the agent which wants to lock it Vertex
         * @exception IllegalStateException
         *                    if Vertex properties are already locked by the
         *                    agent given in parameter
    ...
    /**
         ...
         * @exception IllegalStateException
         *                    if the WhiteBoard is unlock, or if the Agent is
    ...
    /**
         * This method returns a collection of all the keys of a the current
         * vertex for a given agent. If the Vertex WhiteBoard is locked by
    ...
    /**
         * This method is in charge of the beginning of the simulation. It is
         * called when the start button is pressed. It creates all the agents'
         * threads.
         */
    ...
    /**
         * Returns the number of vertices of the graph on which the simulation
         * is done.
         */
    ...
    /**
         * Clean simulator after the death of an agent. This function must only
         * be launch by the agent who wants to die.
         * 
         * @param ag the agent that we want to kill
         */
    public void realyKillAgent(Agent ag) {
    	 	
    	try {
    		/*
    		 * Julien : We must kill the thread before the agent 
    		 */
    ...
    /**
     * Switch off a vertex by deleting verteces which are neighboring the vertex in parameter
     * @param num the number of the vertex
     * @return
     */
    ...
    /**
     * Switch on a vertex by creating verteces which was neighboring the vertex in parameter
     * @param num the number of the vertex
     * @return
     */
	...
	if (!vertex.getVisualization()) {
		...
		if (vert_neighbours.getVisualization()) {
		    SimpleGraphEdge sge = new SimpleGraphEdge(this.getGraph(), vertex, vert_neighbours);
