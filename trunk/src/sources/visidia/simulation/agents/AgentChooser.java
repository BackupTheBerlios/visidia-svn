...
/**
 * This class is used to place agents on a graph using your own code. Have a
 * look at the subclasses for exemples.
 * <p>
 * 
...
public abstract class AgentChooser {
	 ...
	 * 
	 * @param window
	 *            The simulation window which contains the graph on which adding
	 *            agents.
	 */
	 ...
	 * #placeAgents(AgentsSimulatorWndow). On each vertex of the specified
	 * graph, it chooses to add an agent or not.
	 * 
	 * @see #chooseForVertex(Integer)
	 * @see #chooseForVertes(Sommet)
	 * @param graph
	 *            The graph the agents are added to
	 */
	...
	/**
	 * use me to begin placing the agents. Should be called after initializing
	 * some parameters.
	 */
	 ...
	 * 
	 * @param vertex
	 *            The graphical interface vertex on which the choice is done.
	 */
	...
	/**
	 * Adds a new agent to the vertex. Call this method when you decide to put
	 * an agent on one vertex.
	 * 
	 * @param vertexId
	 *            The identity of a vertex you want to put a new agent on.
	 * @param agentName
	 *            Name of the agent to put on the vertex. This is the name of a
	 *            class.
	 */
	...
	/**
	 * Decide here if you want to add an agent on one vertex. Override this
	 * method in your subclasses.
	 * 
	 * @param vertexIdentity
	 *            The vertex identity on which you should decide if you want an
	 *            agent or not.
	 * 
	...
	/**
	 * Overwrite me if you want to make any pre-processing before beginning to
	 * place any agent. Default : call placeAgents.
	 * 
	 * @see placeAgents
