...
/**
 * Cette represente l'évènement associe a l'envoie d'un message sur le réseaux.
 */
public class MessageSendingEvent implements SimulEvent {
	...
	/**
	 * construit un évènement associe à l'envoi du packet <i>mesgPacket</i> sur
	 * le réseau de simulation.
	 */
	public MessageSendingEvent(Long eventNumber, Message message,
