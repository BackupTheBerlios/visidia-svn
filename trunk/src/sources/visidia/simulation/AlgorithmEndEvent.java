...
/**
 * Cette classe représente l'évènement associé à l'envoie d'un message sur le
 * réseaux.
 */
public class AlgorithmEndEvent implements SimulEvent, Serializable {
	...
	/**
	 * return the type that corresponds to algorithm ending. Event and
	 * acknownledge constants are defined in the class SimulConstants.
	 * 
	 * @see SimulConstants
	 */
	public int type() {
