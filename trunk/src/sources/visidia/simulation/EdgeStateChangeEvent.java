...
/**
 * cette classe représente l'évènement associé au changement d'état d'un noeud.
 */
public class EdgeStateChangeEvent implements SimulEvent, Serializable {
	 ...
	 */
	public EdgeStateChangeEvent(Long eventNumber, Integer nodeId1,
			Integer nodeId2, EdgeState newState) {
	...
	/**
	 * donne l'identité de la deuxième extrémité de l'arête qui change d'état.
	 */
