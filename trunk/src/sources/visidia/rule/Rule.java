...
public class Rule implements Serializable {
	 ...
	 *            the star after
	 * @param fc
	 *            a MyVector of forbidden contexts.
	 */
	 ...
	 * synchronisation algorithms are supported by the rule.
	 * 
	...
	/**
	 * this methode decides if the rule can be applied to the context
	 * neighbourhood.
	 * 
	 * @param neighbourhood
	 *            the context.
	...
	/**
	 * return the inverse of a simple rule. exemple: A-N --> U-V {fc} becomes
	 * N-A --> V-U {fc}
	 */
	public Rule inverseSimpleRule() {
		...
		b.setState(0, new Neighbour(this.befor().centerState(), nb.mark(), nb
				.doorNum()));
		a = new Star(na.state(), 1);
		a.setState(0, new Neighbour(this.after().centerState(), na.mark(), na
				.doorNum()));
