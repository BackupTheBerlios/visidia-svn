...
public class Neighbour implements Serializable {
	...
	/**
	 * a constructor from an object Arrow. the state corresponds to the right
	 * value and door is not affected. this method is not used.
	 * 
	 * @param r
	 *            the Arrow
	 */
	...
	/**
	 * a constructor from an object Arrow. the state corresponds to the right
	 * value. this method is not used.
	 * 
	 * @param r
	 *            an Arrow
	 * @param door
	 *            the new number of the door.
	 */
	...
	/**
	 * sets proprieties with value of those of the Neighbour given on
	 * parameters. only the door number is not seted.
	 * 
	 * @param n
	 *            a Neighbour.
	 */
