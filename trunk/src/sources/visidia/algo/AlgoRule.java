	...
	public void init() {
		...
		while (true) {
			...
			if (!this.isFinished()) {
				...
				this.sendTo(neighbour,
						new IntegerMessage(new Integer(mychoice)));
				IntegerMessage ccm = (IntegerMessage) this.receiveFrom(
						neighbour, new IntegerMessageCriterion());
