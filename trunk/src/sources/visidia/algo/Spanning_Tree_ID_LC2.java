...
public class Spanning_Tree_ID_LC2 extends Algorithm {
	...
	public Collection getListTypes() {
		...
		typesList.add(Spanning_Tree_ID_LC2.synchronization);
		typesList.add(Spanning_Tree_ID_LC2.labels);
	...
	public int starSynchro() {
		...
		this.sendAll(new IntegerMessage(new Integer(choosenNumber),
				Spanning_Tree_ID_LC2.synchronization));
