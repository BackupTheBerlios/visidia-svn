 ...
 * pour passer une suite d'objets en argument d'une m�thode,
 * independamment de la structure de donn�es qui contient ces
 * objets.<BR> Cette classe propose des m�thodes statiques pour
 * manipuler les enumerations comme par exemple concatener deux
 * enumerations ou encore pour cr�er simplement de petites
 * enumerations sans �tre oblige de passer par des stuctures de
...
public class OutilsEnum {
  ...
  /**
   * Retourne une enumeration contenant pour uniques �l�ments
  ...
  /**
   * Cr�e une enumeration qui est l'union des deux enumerations
   * pass�es en argument (ie on supprime les doublons). L'ordre n'est
   * pas conserv�.<BR> Ce traitement est beaucoup plus co�teux qu'une
