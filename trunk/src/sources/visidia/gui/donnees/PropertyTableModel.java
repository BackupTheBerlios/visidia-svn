...
public class PropertyTableModel extends AbstractPropertyTableModel {
	...
	public Object getValueAt(int row, int col) {
		...
		case 1:
			return this
					.getTypeName(this.defProps.get(this.keys.elementAt(row)));
		case 2:
			return this.defProps.get(this.keys.elementAt(row));
		}
	...
	public boolean isCellEditable(int row, int col) {
		...
		return ((col == 2) && (!this.keys.elementAt(row).equals("label")) && ((obj instanceof String)
