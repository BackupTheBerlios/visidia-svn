...
/**
 * Cette classe permet d'annuler et de restaurer les deselections des formes
 * dans le graphe.
 */
...
public class ChangeFormeDessin implements UndoObject {
	...
	/**
	 * Construit une nouvelle forme correspondant à la deselection de forme de
	 * selection
	 */
	...
	public void undo() {
		this.nouvelle_forme.getVueGraphe().insererListeAffichage(
				this.ancienne_forme);
		this.ancienne_forme
				.setObjetGraphe(this.nouvelle_forme.getObjetGraphe());
		this.miseAJourModel(this.ancienne_forme);
		this.nouvelle_forme.getVueGraphe().supprimerListeAffichage(
				this.nouvelle_forme);
	}

	public void redo() {
		this.ancienne_forme.getVueGraphe().insererListeAffichage(
				this.nouvelle_forme);
		this.nouvelle_forme
				.setObjetGraphe(this.ancienne_forme.getObjetGraphe());
		this.miseAJourModel(this.nouvelle_forme);
		this.ancienne_forme.getVueGraphe().supprimerListeAffichage(
				this.ancienne_forme);
	}
