...
/*******************************************************************************
 * Cette classe implémente la structure de données utilisée pour gérer les
...
public class UndoInfo extends Vector {
	...
	/* ************************************************************* */
	/*
	 * Méthodes privées "accessoires", pour faciliter l'implémentation des
	 * autres méthodes.
	 */
	/* ************************************************************* */
	 ...
	 * 
	 * @param undo
	 *            la description de l'annulation de l'opération
	 * @param redo
	 *            la description de la restauration l'opération
	 */
	...
	/**
	 * Ajoute une opération dans la liste, et incrémente le nombre d'opérations
	...
	/**
	 * Detruit les informations concernant les groupes crées posterieurement au
	 * groupe courant.
	 */
	...
	/**
	 * Cette méthode permet d'annuler l'opération complexe courante, en annulant
	 * chacune des opérations simples qui la composent.
	 */
	public void undo() {
		if (this.currentGroup() != null) {
	...
	/**
	 * Cette méthode permet de restaurer l'opération complexe courante, en
	 * restaurant chacune des opérations simples qui la composent.
	 */
	public void redo() {
	...
	/**
	 * Retourne VRAI si il reste au moins une opération complexe susceptible
	 * d'être annulée.
	 */
	...
	/**
	 * Retire l'UndoObject qui contient la FormeDessin passée en argument, dans
	 * le groupe courant
	 */
	...
	/**
	 * Cette méthode permet d'annuler les "i" dernières operations (ou toutes
	 * les opérations si il y en a moins de "i")
	 */
	...
	/**
	 * Cette méthode permet de restaurer les "i" dernières opérations (ou toutes
	 * les opérations si il y en a moins de "i")
	 */
