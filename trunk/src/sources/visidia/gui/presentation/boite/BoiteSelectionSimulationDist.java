...
/**
 * Cette boite affiche les caracteristiques d'une sélections d'éléments du
 * graphe courant.
 */
public class BoiteSelectionSimulationDist extends BoiteSelection {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7560510747294181891L;
	...
	public static void show(FenetreDeSimulationDist parent,
			SelectionDessin selection, MultiEnsemble table_types) {
	...
	public JComponent createContent() {
		...
		applyButton.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent event) {
				...
				Enumeration e = BoiteSelectionSimulationDist.this.selection
						.elements();
				while (e.hasMoreElements()) {
					...
					if (element.type().equals("vertex")) {
						...
						((FenetreDeSimulationDist) BoiteSelectionSimulationDist.this.parent)
