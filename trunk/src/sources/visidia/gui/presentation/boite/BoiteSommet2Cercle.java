 ...
 * d'afficher et de modifier les caracteristiques specifiques d'un sommet
 * routage
 */

public class BoiteSommet2Cercle extends BoiteSommetDessin implements
		ActionListener {
			...
			try {
				...
				JOptionPane.showMessageDialog(this.dialog,
						"Bad argument type for the\n"
								+ ((Sommet2Cercle) this.forme).getEtiquette()
										.toLowerCase()
