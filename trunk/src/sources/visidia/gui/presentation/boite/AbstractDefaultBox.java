 ...
 */
public abstract class AbstractDefaultBox implements ActionListener,
		ItemListener, VueEtatPanel {
	...
	public AbstractDefaultBox(AgentsSimulationWindow parent, String titre,
		...
		if (createEtatPanel == true) {
			this.etatPanel = new EtatPanel(TableCouleurs.getTableCouleurs(),
					this);
