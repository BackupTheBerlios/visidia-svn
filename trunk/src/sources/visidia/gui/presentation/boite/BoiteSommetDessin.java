...
public class BoiteSommetDessin extends BoiteFormeDessin {
	...
	/**
	 * Cree une nouvelle boite pour afficher les caracteristiques de "sommet".
	 ...
	 * caracteristiques de "sommet". Suivant la valeur de "est_editable", les
	 * caracteristiques de l'ObjetVisu seront modifiables.
	 */
	public BoiteSommetDessin(JFrame parent, SommetDessin sommet, String titre,
		...
		this.couleur_fond = new LigneChoixCouleur(this,
				"Fill color (R,G,B) : ", sommet.couleurFond().getRed(), sommet
						.couleurFond().getGreen(), sommet.couleurFond()
						.getBlue(), est_editable);
		this.caracteristicsPane.add(this.couleur_fond.panel());

		this.centreX = this.ligne_editable(this.caracteristicsPane, "X :",
				Integer.toString(this.initialXvalue), est_editable);
		this.centreX.addActionListener(this);

		this.centreY = this.ligne_editable(this.caracteristicsPane, "Y :",
				Integer.toString(this.initialYvalue), est_editable);
	...
	public void buttonOk() {
		...
		try {
			fond = new Color(this.couleur_fond.getRed(), this.couleur_fond
					.getGreen(), this.couleur_fond.getBlue());
	...
	/**
	 * Cette methode permet d'activer ou de desactiver le bouton de selection de
	 * la couleur de fond du SommetDessin, en fonction de la valeur du booleen
	 * passe en argument..
	 */
