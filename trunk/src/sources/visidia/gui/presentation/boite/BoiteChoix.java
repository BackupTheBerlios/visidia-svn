...
/**
 * Cette classe cree une boite utilisée pour afficher et modifier la table des
 * correspondances etat-couleur
 */
public class BoiteChoix implements ActionListener {
	...
	public BoiteChoix(Editeur parent, String titre) {
		...
		this.dialog.getContentPane().add(this.plancheDeCouleurs,
				BorderLayout.NORTH);
