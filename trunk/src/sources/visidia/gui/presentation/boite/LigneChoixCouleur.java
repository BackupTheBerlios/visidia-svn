...
/**
 * Cette classe crée un panel qui contient un bouton et un label. Le label
 * affiche la valeur d'une couleur (format R,G,B), et le bouton permet d'ouvrir
 * une boite de choix de couleur. Ce panel sera affiché a l'interieur d'une
 * fenêtre, sous la forme d'une ligne. L'existence de cette classe permet de
 * simplifier le choix d'une nouvelle couleur.
 * 
 */
...
public class LigneChoixCouleur implements ActionListener {
	...
	/**
	 * La BoiteFormeDessin parente (on en a besoin pour appeller une methode si
	 * la couleur choisie est modifiee).
	 */
	 ...
	 * 
	 * @param parent
	 *            la BoiteFormeDessin parente.
	 * @param label
	 *            le texte affiche dans le label.
	 * @param R
	 *            la composante rouge de la couleur d'origine.
	 * @param G
	 *            la composante verte de la couleur d'origine.
	 * @param B
	 *            la composante bleue de la couleur d'origine.
	 * @param editable
	 *            si ce booleen vaut VRAI, le bouton sera actif, sinon, il sera
	 *            inactif.
	 */
	LigneChoixCouleur(BoiteFormeDessin parent, String label, int R, int G,
			int B, boolean editable) {
	...
	/**
	 * Active ou désactive le bouton suivant la valeur du booleen "editable"
	 * passe en argument.
	 */
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.button) {
			Color choosedColor = JColorChooser.showDialog(this.parent.dialog(),
					"Choose color", new Color(this.R, this.G, this.B));
