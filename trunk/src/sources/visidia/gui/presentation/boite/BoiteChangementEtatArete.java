...
public class BoiteChangementEtatArete implements ActionListener, ItemListener {
	...
	/**
	 * Ce booleen vaut VRAI si une des caracteristiques de l'ObjetVisu a ete
	...
	public void initialisation(Ensemble uneSelection, String titre) {
	...
	/**
	 * Cette methode est appelée si l'utilisateur appuie sur le bouton Ok.
	 */
