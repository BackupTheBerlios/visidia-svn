 ...
 * d'afficher et de modifier les caracteristiques specifiques d'un sommet carre
 */

public class BoiteSommetCarre extends BoiteSommetDessin implements
		ActionListener {
			...
			try {
				...
				JOptionPane.showMessageDialog(this.dialog,
						"Bad argument type for the\n"
								+ ((SommetCarre) this.forme).getEtiquette()
										.toLowerCase()
