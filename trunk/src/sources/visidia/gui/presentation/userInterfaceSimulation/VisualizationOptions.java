...
public final class VisualizationOptions extends JMenu implements ActionListener {
	...
	public VisualizationOptions(FenetreDeSimulation fenetreSim) {
		...
		this.itemForAllAlgorithmMess = new JCheckBoxMenuItem(
				"All algorithm messages", true);
		this.itemForAllSynchrMess = new JCheckBoxMenuItem(
				"All synchronization messages", true);
		this.itemForAnyAlgorithmMess = new JCheckBoxMenuItem(
				"No algorithm message");
		this.itemForAnySynchrMess = new JCheckBoxMenuItem(
