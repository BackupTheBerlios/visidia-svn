...
public class SaveTrace extends JFileChooser {
	...
	public void approveSelection() {
		...
		/*
		 * if (getSelectedFile().exists()) { int overwrite =
		 * JOptionPane.showConfirmDialog(this, getName(getSelectedFile()) + " :
		 * this file aldready exists.\n" + "Do you want to overwrite it ?",
		 * "Warning", JOptionPane.YES_NO_OPTION); if (overwrite ==
		 * JOptionPane.YES_OPTION) { super.approveSelection(); } else {
		 * setSelectedFile(validFile); } } else { if (save) {
