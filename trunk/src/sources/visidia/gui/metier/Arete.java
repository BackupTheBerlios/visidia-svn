...
public class Arete extends ObjetGraphe implements Cloneable {
	...
	/**
	 * construct a new edge in un_graphe precising the two vertices origin and
	 * destination
	 */
	...
	/**
	 * duplicate the current vertex with origin and destination for vertices at
	 * extremity
	 */
	...
	public Object cloner() {
		return this.cloner((Sommet) this.origine.cloner(),
				(Sommet) this.destination.cloner());
	}
	...
	/**
	 * returns the other vertex of the edge ... (un_sommet is a vertex of the
	 * edge)
	 */
