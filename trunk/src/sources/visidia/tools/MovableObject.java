...
public class MovableObject {
	...
	/**
	 * Return true if this mobil is betoween the segment end points. A point M
	 * is located into the segment AB if the value of the vector scalar product
	 * MA . MB is positif.
	 */
	public boolean isIntoBounds() {
		return ((this.x - this.ax) * (this.x - this.bx) + (this.y - this.ay)
				* (this.y - this.by)) <= 0;
	}
