...
public class TableSorter extends AbstractTableModel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3976186444057618680L;
	...
	protected Comparator getComparator(int column) {
		...
		Comparator comparator = (Comparator) this.columnComparators
				.get(columnType);
		if (comparator != null) {
			return comparator;
		}
	...
	private class Row implements Comparable {
		...
		public int compareTo(Object o) {
			...
			for (Iterator it = TableSorter.this.sortingColumns.iterator(); it
					.hasNext();) {
				...
				if ((o1 == null) && (o2 == null)) {
					...
					comparison = TableSorter.this.getComparator(column)
							.compare(o1, o2);
				}
				if (comparison != 0) {
		...
		public void tableChanged(TableModelEvent e) {
			...
			if ((e.getFirstRow() == e.getLastRow())
				...
				TableSorter.this.fireTableChanged(new TableModelEvent(
						TableSorter.this, viewIndex, viewIndex, column, e
								.getType()));
				return;
			}
