...
sources/visidia/gui/presentation/*.java
sources/visidia/gui/presentation/factory/*.java
sources/visidia/simulation/*.java
sources/visidia/simulation/agents/*.java sources/visidia/algo/*.java
sources/visidia/algo/synchronous/*.java sources/visidia/algoRMI/*.java
