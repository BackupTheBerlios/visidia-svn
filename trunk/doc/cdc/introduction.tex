...
arêtes sont les liens de communication.
...
mais la mémoire d'un sommet contient le tableau blanc (ou
\texttt{whiteboard} contenant les variables déclarées) et l'état de ses ports.

\subsubsection*{Communication par envoi de messages}
...
\subsubsection*{Version avec agent mobile}
