...
\begin{figure}[ht]
  ...
  \caption{Les types des réseaux en terme de synchronisation, un shéma pareil peut être élaboré en s'appuiant sur la connaissance ou pas des noeuds du réseau}
  \label{fig:algodist}
\end{figure}
...
\begin{figure}[ht]
  ...
  \caption{Algorithme n°2 : Exemple d'algorithme à base de régles de réecritures}
  \label{fig:algodist2}
\end{figure}
