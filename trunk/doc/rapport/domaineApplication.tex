...
\begin{itemize}
  \item le mode synchrone où le temps est une donnée globale du
    réseau, c'est-à-dire que les instructions ou blocs d'instructions de
...
Soit G un anneau, asynchrone avec échange de messages asynchrones, à trois
...
\begin{itemize}
  \item Construction d'objets parallèles : un exemple des applications dans ce
  		domaine est mené par le PRISM\footnote{Laboratoire  de recherche en
  		informatique  sur les thèmes 
		du Parallélisme, des Réseaux, des Systèmes et de la
		Modélisation (\url{http://www.prism.uvsq.fr/)}.}, il consiste dans la
