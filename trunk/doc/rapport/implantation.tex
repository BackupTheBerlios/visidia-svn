...
pour les même raisons qu'évoqué précédemment.
...
graphique.  Le fonctionnement  de cette  communication est  analogue à
celui du  simulateur déjà existant. Le  simulateur informe l'interface
graphique d'un  évènement en créant un  objet de type  approprié et le
...
méthodes utilisent le même mot-clé afin gérer la concurrence.

\section{GUI}
Cette partie de l'application est la plus important du point de vue de
l'utilisateur car c'est grâce à  elle qu'il va pouvoir interagir avec
\visidia.
...
redéfinir afin de choisir le comportement suivant lequel seront placer
