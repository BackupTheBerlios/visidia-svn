...
- axe du module 
- fait appel à lui pour tous les actions des agents
...
- acces concurrents / utilisation du mot cle synchronized
- 2 types d'agents / comment AgentSynchronized est implante (nextPulse)
- planning
- agent mover
- agent chooser
- experimentation/statistiques/evenement/rapport de stats
- faire  une  section  sur  les  whiteboards  (pourquoi  2  tables  de
- hachages)
- la classe Bag
- les tables de hachages a la place des Vector
- les UpdateTable/TableModel

- revoir le cahier des charges pour avoir d'autres idees
%% Local Variables: 
%% mode: latex
%% TeX-master: t
%% TeX-PDF-mode: t
