...
\item[nextTop] bloque l'agent jusqu'à ce que tous les agents de notre
...
un nombre d'agents (1,2,...,*).  Le logiciel se charge alors  de répartir ce
...
On souhaite également donner la possibilité à l'utilisateur de
spécifier un algorithme de placement des agents (en affectant, par
exemple, à chaque sommet une probabilité d'y placer un agent).
\end{itemize}
