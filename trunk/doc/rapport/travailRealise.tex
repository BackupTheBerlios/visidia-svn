...
la possibilité de surcharger, dans les sous classe de la classe \textit{Agent}les méthodes
\textit {processingAgentWhenSwitchingOff()} et 
\textit{processingAgentIsolated()} qui définissent les comportements de l'agent 
