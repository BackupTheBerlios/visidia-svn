...
réécriture ne sont pas totalement implantées : les contextes sont par
exemple manquants.
...
cliquant sur  le bouton \textbf{}start. Tous  les agents que  vous avez ajoutés
...
graphique. En plus,  ils  permettent  la  modification des  variables
durant la simulation par l'utilisateur et donc de simuler des erreurs.
...
les  sommets en utilisant  des whiteboards. Ce  sont les
...
\begin{figure}[ht]
  ...
  \caption{Après  avoir  cliqué  sur  \textbf{Statistics} vous  devez  choisir
...
reél,  et les  déplacements des  agents seront  toujours  visibles sur
