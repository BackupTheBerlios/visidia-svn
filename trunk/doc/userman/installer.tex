...
\section{Récupérer la version stable}

Pour récupérer la version stable,   allez   sur    le   site
\url{https://developer.berlios.de/projects/visidia/}. Au  milieu de la
page,  vous trouverez  une  section nommée  \og Dernières révisions  des
fichiers \fg. Cliquez  alors sur le lien téléchargement  et récupérez le
...
\section{Récupérer la version en développement}
...
La première  ligne compile \visidia  et les
modules  comme les algorithmes,  les agents  etc.  La  deuxième lance
...
Si tout  s'est bien passé,  \visidia devrait être lancé.  Vous devriez
