...
liberté dans le choix de la valeur qui peut être unestructure
...
plupart des cas les états prédéfinis devrait vous suffire. Ceux-ci sont au nombre
...
l'agent courant, la mémoire n'est pas copiée --- de l'agent en utilisant lea
...
votre algorithme peu avoir des résultats surprenants.
