...
\subsection{Ajouter un ou des agents au graphe}
...
\item Le placement  automatique grâce au placeur
...
\subsubsection{Ajouter des agents de façon programmée}
...
\subsubsection{Ajouter des agents définis avec des règles de réécritures}
...
\subsection{Utilisation des WhiteBoards}
...
\subsubsection{WhiteBoards des sommets}
...
\subsubsection{Modification des whiteboards}
...
Cas particulier  : On considère que  le whiteboard propre  à un sommet
est  prioritaire   par  rapport  au  whiteboard  global   à  tous  les
...
\textbf{Suppression d'une variable}\\
...
\textbf{Modification d'une variable}\\
...
Cas particulier  : Si  vous souhaitez modifier  le label  d'un sommet,
vous devez utiliser  la liste déroulante située en  haut à droite des
whiteboards locaux des sommets.
...
sur chaque sommet.  Pour mémoriser le nombre de passage sur chaque
