...
\begin{figure}[ht]
  ...
  \caption{Les  règles de réécritures  sont implantées  dans \visidia.
    ...
    Cette règle dit: ``Si $u$ est  un sommet de label ``A'' qui a pour
    ...
    exclusion qui est cachée sous l'onglet ``Context 2'')''.}
...
L'accès et la modification de valeurs se font de 2 façons : 
...
\begin{figure}[ht]
  ...
  \caption{Après  avoir sélectionné  un sommet  et cliqué  sur l'icone
