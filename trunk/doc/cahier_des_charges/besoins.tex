...
détecter qu'un autre \emph{agent} est sur le même sommet, au sur la
même arète. Cela va imposer la mise en place de règles de priorités,
pour que plusieurs \emph{agents} ne puissent pas agir simultanément
sur un même sommet.\\


L'inialisation des objets se fera au plus tard. En effet, ils ne
...
passage d'un \emph{agent}, s'il doit leur affecter une valeur.
