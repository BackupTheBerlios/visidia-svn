...
ainsi que le système se décompose en trois grandes fonctionnalités :
\begin{itemize}
...
Une version plus complète est présentée sur la figure
...
déplacement aux agents. Certains  types de déplacements seront fournis
