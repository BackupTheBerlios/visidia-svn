...
indépendantes,  elles sont  susceptibles d'avoir  lieu en  même temps,
sinon  on choisit  d'une façon  non déterministe  la  transformation à
effectuer.

\subsubsection{Preuve de la correction d'un algorithme distribué}
...
existent. Dans cette partie il  ne s'agit pas de traiter ces problèmes
mais juste d'en donner une idée.
...
systèmes   distribués,  ces   derniers  sont   devenus   une  solution
